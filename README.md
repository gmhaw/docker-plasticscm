...
|---|---|---|---|
|[latest](https://hub.docker.com/r/gmhaw/plasticscm-server-netcore/tags?name=latest)|Always the latest version of both Ubuntu and PlasticSCM.|**2022-06-23**|[Permalink](https://www.plasticscm.com/download/releasenotes/11.0.16.7110)
|[bionic](https://hub.docker.com/r/gmhaw/plasticscm-server-netcore/tags?name=bionic)|Ubuntu release using the latest supported version of PlastiSCM.|**2022-06-23**|[Permalink](https://www.plasticscm.com/download/releasenotes/11.0.16.7110)
|[11.0.16.7110](https://hub.docker.com/r/gmhaw/plasticscm-server-netcore/tags?name=11.0.16.7110)|Specific release on the latest supported version of Ubuntu.|**2022-06-23**|[Permalink](https://www.plasticscm.com/download/releasenotes/11.0.16.7110)
|[11](https://hub.docker.com/r/gmhaw/plasticscm-server-netcore/tags?name=11)|Latest v11 release on the latest supported version of Ubuntu.|**2022-06-23**|[Permalink](https://www.plasticscm.com/download/releasenotes/from/11.0.16.6683/to/11.0.16.7110)
